...
function createSeedDocuments(uid, email, now) {
    ...
    waterRecommendations: [
      {
        ...
        reason: 'Main raised bed is below its weekly water target.',
        recommendationDate: toLocalDate(new Date(now)),
        recommendedWaterInches: 0.35,
        refreshedAtIso: now,
        status: 'active',
        suppressUntilIso: null,
        targetId: 'bed-main',
        targetLabel: 'Main raised bed',
        targetType: 'bed',
        urgency: 'high',
  ...
  const plantings = [
    ...
    },
    {
      ...
      mode: 'trellisLine',
      mulched: false,
      notes: 'Optimizer should keep cucumbers near a support.',
      plantCount: 6,
      plantedOn: null,
  ...
  const tasks = [
    {
      ...
      status: 'open',
      structureId: 'bed-main',
      title: 'Water main raised bed 0.35 in',
      type: 'water',
    },
    {
      bedLabel: 'Main raised bed',
  ...
  const notificationLogs = [
    {
      ...
      attemptCount: 1,
      body: 'Water Main raised bed 0.35 in today. Recent rain is low and no soaking rain is forecast.',
      channel: 'inApp',
      createdAtIso: now,
      ...
      messageSummary: 'Water main raised bed today',
      provider: 'inApp',
